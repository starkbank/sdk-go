...
func main() {
  ...
  holders := corporateholder.Query(params, nil)
...
func main() {
    ...
    merchantcards := MerchantCard.Query(params, nil)

    for merchantcard := range merchantcards {
...
func main() {
    ...
    merchantpurchases := MerchantPurchase.Query(params, nil)

    for merchantpurchase := range merchantpurchases {
...
func main() {
    ...
    merchantinstallments := MerchantInstallment.Query(params, nil)

    for merchantinstallment := range merchantinstallments {
