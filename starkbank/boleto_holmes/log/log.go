...
type Log struct {
	Id      string       `json:"id"`
	Holmes  BoletoHolmes `json:"holmes"`
	Type    string       `json:"type"`
	Created string       `json:"created"`
}

var resource = map[string]any{"class": Log{}, "name": "BoletoHolmesLog"}

func Get() {
	//	Retrieve a specific boletoholmes.Log
	//	Receive a single boletoholmes.Log object previously created by the Stark Bank API by its id
	//
	//	Parameters (required):
...
func Query() {
	...
	//	- types [list of strings, default None]: filter for log event types. ex: ["solving", "solved"]
	//	- holmes_ids [list of strings, default None]: list of BoletoHolmes ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
	//	- user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkbank.user was set before function call
	//
	//	Return:
