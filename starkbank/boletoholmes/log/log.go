...
func Query(params map[string]interface{}, user user.User) chan Log {
	...
	//
	//	Receive a generator of BoletoHolmes.Log structs previously created in the Stark Bank API
	//
	//	Parameters (required):
	//	- user [Organization/Project struct, default nil]: Organization or Project struct. Not necessary if starkbank.user was set before function call
	//
	...
	//
	//	Return:
	//	- Generator of BoletoHolmes.Log structs with updated attributes
	logs := make(chan Log)
...
func Page(params map[string]interface{}, user user.User) ([]Log, string, Error.StarkErrors) {
	...
	//
	//	Receive a list of up to 100 BoletoHolmes.Log structs previously created in the Stark Bank API and the cursor to the next page.
	...
	//
	//	Return:
	//	- List of BoletoHolmes.Log structs with updated attributes
